    ...
    <div className="min-h-screen bg-[#2D336B] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden">
          ...
          <div className="relative bg-gradient-to-br from-[#2D336B] to-[#4A5194] pt-12 pb-32 px-6">
            {/* Wave Shape */}
          ...
          <div className="bg-[#FFF2F2] px-8 pt-8 pb-10">
            <h2 className="text-center text-gray-800 text-2xl mb-8">Welcome back !</h2>
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-2">
                  <Checkbox
                    ...
                    className="border-[#2D336B] data-[state=checked]:bg-[#2D336B]"
                  />
                  <label htmlFor="remember" className="text-sm text-gray-600 cursor-pointer">
                    Remember me
                  </label>
                </div>
                <button className="text-sm text-gray-500 hover:text-[#2D336B]">
                  Forgot password?
                </button>
              </div>
